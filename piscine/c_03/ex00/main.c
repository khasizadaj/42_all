...
int main(void)
{
	char *test_1_s1 = "Hello";
	char *test_1_s2 = "Hello";
	int test_1_result = ft_strcmp(test_1_s1, test_1_s2);
	int test_1_result_expected = strcmp(test_1_s1, test_1_s2);
	printf("Test 1\n");
	printf("W1:\t%s\n", test_1_s1);
	printf("W2:\t%s\n", test_1_s2);
	...
	int test_2_result = ft_strcmp(test_2_s1, test_2_s2);
	int test_2_result_expected = strcmp(test_2_s1, test_2_s2);
	printf("Test 2\n");
	printf("W1:\t%s\n", test_2_s1);
	printf("W2:\t%s\n", test_2_s2);
	...
	int test_3_result = ft_strcmp(test_3_s1, test_3_s2);
	int test_3_result_expected = strcmp(test_3_s1, test_3_s2);
	printf("Test 3\n");
	printf("W1:\t%s\n", test_3_s1);
	printf("W2:\t%s\n", test_3_s2);
	...
	int test_4_result = ft_strcmp(test_4_s1, test_4_s2);
	int test_4_result_expected = strcmp(test_4_s1, test_4_s2);
	printf("Test 4\n");
	printf("W1:\t%s\n", test_4_s1);
	printf("W2:\t%s\n", test_4_s2);
	...
	int test_5_result = ft_strcmp(test_5_s1, test_5_s2);
	int test_5_result_expected = strcmp(test_5_s1, test_5_s2);
	printf("Test 5\n");
	printf("W1:\t%s\n", test_5_s1);
	printf("W2:\t%s\n", test_5_s2);
	...
	int test_empty_1_result = ft_strcmp(test_empty_1_s1, test_empty_1_s2);
	int test_empty_1_result_expected = strcmp(test_empty_1_s1, test_empty_1_s2);
	printf("Test case 1:\n");
	printf("W1: \"%s\"\n", test_empty_1_s1);
	printf("W2: \"%s\"\n", test_empty_1_s2);
	...
	int test_empty_2_result = ft_strcmp(test_empty_2_s1, test_empty_2_s2);
	int test_empty_2_result_expected = strcmp(test_empty_2_s1, test_empty_2_s2);
	printf("Test case 2:\n");
	printf("W1: \"%s\"\n", test_empty_2_s1);
	printf("W2: \"%s\"\n", test_empty_2_s2);
	...
	int test_empty_3_result = ft_strcmp(test_empty_3_s1, test_empty_3_s2);
	int test_empty_3_result_expected = strcmp(test_empty_3_s1, test_empty_3_s2);
	printf("Test case 3:\n");
	printf("W1: \"%s\"\n", test_empty_3_s1);
	printf("W2: \"%s\"\n", test_empty_3_s2);
	...
	int test_whitespace_1_result = ft_strcmp(test_whitespace_1_s1, test_whitespace_1_s2);
	int test_whitespace_1_result_expected = strcmp(test_whitespace_1_s1, test_whitespace_1_s2);
	printf("Test case 4:\n");
	...
	int test_whitespace_2_result = ft_strcmp(test_whitespace_2_s1, test_whitespace_2_s2);
	int test_whitespace_2_result_expected = strcmp(test_whitespace_2_s1, test_whitespace_2_s2);
	printf("Test case 5:\n");
